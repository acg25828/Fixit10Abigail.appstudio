...
const cacheName = 'Fixit10Abigail-2020-11-15 10:48:17.810945'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Fixit10Abigail'.length) === 'Fixit10Abigail') {
